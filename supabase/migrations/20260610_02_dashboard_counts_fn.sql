-- ═══════════════════════════════════════════════════════════════════════
-- Migration: crm_dashboard_counts RPC
-- Replaces 14 individual client queries with a single DB function call.
-- Returns all dashboard KPIs in one JSON payload.
-- ═══════════════════════════════════════════════════════════════════════
...
-- Grant execute to authenticated users (RLS inside function checks via SECURITY DEFINER context)
